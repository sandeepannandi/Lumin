...
export default function HairScreen({ onBack, onNavigateToSkin }: HairScreenProps) {
  ...
  const featuredItems = [
    { id: 1, title: 'Summer Hair', subtitle: 'Light & Breezy', image: require('../assets/images/f1.png') },
    { id: 2, title: 'Winter Hair', subtitle: 'Cozy & Warm', image: require('../assets/images/f2.png') },
    { id: 3, title: 'Party Hair', subtitle: 'Elegant & Glamorous', image: require('../assets/images/f3.png') },
    { id: 4, title: 'Casual Hair', subtitle: 'Comfortable & Stylish', image: require('../assets/images/f4.png') },
    { id: 5, title: 'Office Hair', subtitle: 'Professional & Chic', image: require('../assets/images/f5.png') },
    { id: 6, title: 'Weekend Hair', subtitle: 'Relaxed & Trendy', image: require('../assets/images/f6.png') },
    { id: 7, title: 'Date Night Hair', subtitle: 'Romantic & Alluring', image: require('../assets/images/f7.png') },
    { id: 8, title: 'Travel Hair', subtitle: 'Versatile & Practical', image: require('../assets/images/f8.png') },
    { id: 9, title: 'Athleisure Hair', subtitle: 'Active & Fashionable', image: require('../assets/images/f9.png') },
    { id: 10, title: 'Evening Hair', subtitle: 'Sophisticated & Elegant', image: require('../assets/images/f10.png') },
    { id: 11, title: 'Street Hair', subtitle: 'Urban & Edgy', image: require('../assets/images/f11.png') }
  ];

  const occasionItems = [
    { id: 1, title: 'Wedding', image: require('../assets/images/wedding.jpg') },
    { id: 2, title: 'Party', image: require('../assets/images/party.jpg') },
    { id: 3, title: 'Office', image: require('../assets/images/office.jpg') },
    { id: 4, title: 'Casual', image: require('../assets/images/casual.jpg') },
    { id: 5, title: 'Date Night', image: require('../assets/images/datenight.jpg') },
    { id: 6, title: 'Travel', image: require('../assets/images/travel.jpg') },
    { id: 7, title: 'College', image: require('../assets/images/college.jpg') },
    { id: 8, title: 'Birthday', image: require('../assets/images/birthday.jpg') },
    { id: 9, title: 'Night Out', image: require('../assets/images/nightout.jpg') },
    { id: 10, title: 'Gym', image: require('../assets/images/gym.jpg') }
  ];
          ...
          <View style={styles.categorySection}>
            <View style={styles.categoryContainer}>
              ...
              <View style={styles.categoryRow}>
                {[
                  { name: 'Pixie Cut', image: require('../assets/images/pixie.jpg') },
                  { name: 'Long Bob', image: require('../assets/images/longbob.jpg') },
                  { name: 'Curtain Bangs', image: require('../assets/images/curtain.jpg') },
                  { name: 'High Ponytail', image: require('../assets/images/ponytail.jpg') },
                ].map((category, index) => (
                  <TouchableOpacity key={index} style={styles.categoryItem}>
                                         <View style={styles.categoryImageContainer}>
                       <Image source={category.image} style={[
                         styles.categoryImage,
                         category.name === 'Long Bob' && styles.longBobImage
                       ]} />
                     </View>
              ...
              <View style={styles.categoryRow}>
                {[
                  { name: 'Messy Bun', image: require('../assets/images/messybun.jpg') },
                  { name: 'French Braid', image: require('../assets/images/braid.jpg') },
                  { name: 'Wolf Cut', image: require('../assets/images/wolf.jpg') }
                ].map((category, index) => (
             ...
             <View style={styles.discoverSection}>
               ...
               <View style={styles.discoverContainer}>
                 ...
                 <TouchableOpacity style={styles.discoverBox}>
                   <View style={styles.discoverImageContainer}>
                     <Image source={require('../assets/images/fashion.jpg')} style={styles.discoverImage} />
                   </View>
            ...
            <View style={styles.featuredSection}>
             ...
             <View style={styles.virtualTryOnSection}>
               <TouchableOpacity style={styles.virtualTryOnContainer}>
                 <Image source={require('../assets/images/hairtryon.png')} style={styles.virtualTryOnBackground} />
